...
export type SelectionInputItemInit = SelectionInputItemProps & {
  action?: Action;
  name: string;
};

export class SelectionInputItem extends RenderableComponent {
  constructor(
 ...
 */
export class SelectionInput extends RenderableComponent {
